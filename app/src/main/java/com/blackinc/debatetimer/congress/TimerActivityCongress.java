 ...
 */
public class TimerActivityCongress extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.congress_activity_timer);
    ...
    private void circularRevealActivity() {
        ...
        Animator circularReveal = ViewAnimationUtils.createCircularReveal(rootLayout, MainActivityCongress.cxCong,
                MainActivityCongress.cyCong,0, finalRadius);
    ...
    private void endCircularRevealActivity() {
        ...
        // create the animator for this view (the start radius is zero)
        Animator circularReveal = ViewAnimationUtils.createCircularReveal(rootLayout, MainActivityCongress.cxCong,
                MainActivityCongress.cyCong, finalRadius, 0);
        circularReveal.setDuration(400);
    ...
    public void onStop() {
        ...
        TaskDescription taskDescription = new TaskDescription("Congress Timer", icon, Color.parseColor("#000000"));
    ...
    public void onResume(){
        ...
        timerTitle.setText(MainActivityCongress.timerTitle);
        ...
        anim.setDuration(MainActivityCongress.seconds);
    ...
    public void launchMain(View view) {
        ...
        //finish();
        //startActivity(new Intent(TimerActivityLD.this, MainActivityCongress.class));
    }
    ...
    public void start(View view) {
        seconds = MainActivityCongress.seconds;
        started = true;
        if (!paused) {
            paused = true;
            ...
            countDownTimer = new CountDownTimer(seconds, 1000) {
                ...
                public void onTick(long millisUntilFinished) {
                    ...
                    MainActivityCongress.seconds = MainActivityCongress.seconds - 1000;
                }
