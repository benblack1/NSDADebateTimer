...
public class Cong_1Con extends Fragment {
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        return inflater.inflate(R.layout.cong_firstcon, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        text.setText(times.get(Integer.parseInt(sp.getString("cong_sp", "3"))));
    }
}