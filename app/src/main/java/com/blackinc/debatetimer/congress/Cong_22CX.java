...
public class Cong_22CX extends Fragment {
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        return inflater.inflate(R.layout.cong_secondsecondcx, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        text.setText(times.get(Integer.parseInt(sp.getString("cong_2cx", "1"))));
    }
}