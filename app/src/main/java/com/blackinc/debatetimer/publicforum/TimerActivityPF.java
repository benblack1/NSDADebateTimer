 ...
 */
public class TimerActivityPF extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pf_activity_timer);
    ...
    public void onStop() {
        ...
        TaskDescription taskDescription = new TaskDescription("Public Forum Timer", icon, Color.parseColor("#000000"));
    ...
    public void onResume() {
        ...
        timerTitle.setText(MainActivityPF.timerTitle);
        ...
        if(MainActivityPF.prep){
            if(MainActivityPF.first){
                anim.setDuration(MainActivityPF.firstPrepSeconds);
            }
            else if(!MainActivityPF.first){
                anim.setDuration(MainActivityPF.secondPrepSeconds);
            }
        }
        else if(!MainActivityPF.prep) {
            anim.setDuration(MainActivityPF.seconds);
        }
    ...
    public void start(View view) {
        seconds = MainActivityPF.seconds;
        started = true;
        if (!paused) {
            paused = true;
            ...
            countDownTimer = new CountDownTimer(seconds, 1000) {
                ...
                public void onTick(long millisUntilFinished) {
                    ...
                    MainActivityPF.seconds = MainActivityPF.seconds - 1000;
                }
    ...
    public void startFirstPrep(View view) {
        seconds = MainActivityPF.firstPrepSeconds;
        started = true;
        if (!paused) {
            paused = true;
            ...
            countDownTimer = new CountDownTimer(seconds, 1000) {
                ...
                public void onTick(long millisUntilFinished) {
                    ...
                    MainActivityPF.firstPrepSeconds = MainActivityPF.firstPrepSeconds - 1000;
                }
    ...
    public void startSecondPrep(View view) {
        seconds = MainActivityPF.secondPrepSeconds;
        started = true;
        if (!paused) {
            paused = true;
            ...
            countDownTimer = new CountDownTimer(seconds, 1000) {
                ...
                public void onTick(long millisUntilFinished) {
                    ...
                    MainActivityPF.secondPrepSeconds = MainActivityPF.secondPrepSeconds - 1000;
                }
