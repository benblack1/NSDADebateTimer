...
public class MainActivityWS extends AppCompatActivity {
    ...
    public static int cxWS;
    public static int cyWS;
    private int[] array;
    ...
    public void onStop() {
        ...
        TaskDescription taskDescription = new TaskDescription("World Schools Timer", icon, Color.parseColor("#6A1B9A"));
    ...
    public void onResume (){
        ...
        TaskDescription taskDescription = new TaskDescription("World Schools Timer", icon, Color.parseColor(sp.getString("ws_color","-1")));
        ((Activity)this).setTaskDescription(taskDescription);
    ...
    public void timer1Pro (View view){
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(this);
        seconds = (Integer.parseInt(sp.getString("ws_ts", "8")) * 60000) + 200;
        timerTitle = "1P";
        //First = true;
        ...
        cxWS = array[0] + viewer.getWidth()/2;
        cyWS = array[1] + viewer.getHeight()/2;
        startActivity(new Intent(MainActivityWS.this, TimerActivityWS.class));
    }

    public void timer1Opp (View view){
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(this);
        seconds = (Integer.parseInt(sp.getString("ws_ts", "8")) * 60000) + 200;
        timerTitle = "1O";
        //Second = true;
        position = 2;
        array = new int[2];
        View viewer = findViewById(R.id.firstolaunch);
        viewer.getLocationOnScreen(array);
        cxWS = array[0] + viewer.getWidth()/2;
        cyWS = array[1] + viewer.getHeight()/2;
        startActivity(new Intent(MainActivityWS.this, TimerActivityWS.class));
    ...
    public void timer2Pro (View view){
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(this);
        seconds = (Integer.parseInt(sp.getString("ws_ts", "8")) * 60000) + 200;
        timerTitle = "2P";
        position = 3;
        array = new int[2];
        View viewer = findViewById(R.id.secondplaunch);
        viewer.getLocationOnScreen(array);
        cxWS = array[0] + viewer.getWidth()/2;
        cyWS = array[1] + viewer.getHeight()/2;
        startActivity(new Intent(MainActivityWS.this, TimerActivityWS.class));
    ...
    public void timer2Opp (View view){
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(this);
        seconds = (Integer.parseInt(sp.getString("ws_ts", "8")) * 60000) + 200;
        timerTitle = "2O";
        position = 4;
        array = new int[2];
        View viewer = findViewById(R.id.secondolaunch);
        viewer.getLocationOnScreen(array);
        cxWS = array[0] + viewer.getWidth()/2;
        cyWS = array[1] + viewer.getHeight()/2;
        startActivity(new Intent(MainActivityWS.this, TimerActivityWS.class));
    ...
    public void timer3Pro (View view){
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(this);
        seconds = (Integer.parseInt(sp.getString("ws_ts", "8")) * 60000) + 200;
        timerTitle = "3P";
        position = 5;
        array = new int[2];
        View viewer = findViewById(R.id.thirdplaunch);
        viewer.getLocationOnScreen(array);
        cxWS = array[0] + viewer.getWidth()/2;
        cyWS = array[1] + viewer.getHeight()/2;
        startActivity(new Intent(MainActivityWS.this, TimerActivityWS.class));
    ...
    public void timer3Opp (View view){
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(this);
        seconds = (Integer.parseInt(sp.getString("ws_ts", "8")) * 60000) + 200;
        timerTitle = "3O";
        position = 6;
        array = new int[2];
        View viewer = findViewById(R.id.thirdolaunch);
        viewer.getLocationOnScreen(array);
        cxWS = array[0] + viewer.getWidth()/2;
        cyWS = array[1] + viewer.getHeight()/2;
        startActivity(new Intent(MainActivityWS.this, TimerActivityWS.class));
    ...
    public void timerOppRep (View view){
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(this);
        seconds = (Integer.parseInt(sp.getString("ws_rb", "4")) * 60000) + 200;
        timerTitle = "OR";
        position = 7;
        array = new int[2];
        View viewer = findViewById(R.id.oppreplaunch);
        viewer.getLocationOnScreen(array);
        cxWS = array[0] + viewer.getWidth()/2;
        cyWS = array[1] + viewer.getHeight()/2;
        startActivity(new Intent(MainActivityWS.this, TimerActivityWS.class));
    ...
    public void timerProRep (View view){
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(this);
        seconds = (Integer.parseInt(sp.getString("ws_rb", "4")) * 60000) + 200;
        timerTitle = "PR";
        position = 0;
        array = new int[2];
        View viewer = findViewById(R.id.proreplaunch);
        viewer.getLocationOnScreen(array);
        cxWS = array[0] + viewer.getWidth()/2;
        cyWS = array[1] + viewer.getHeight()/2;
        startActivity(new Intent(MainActivityWS.this, TimerActivityWS.class));
