...
public class TimerActivityBQ extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bq_activity_timer);
        ...
        timerTitle.setText(MainActivityBQ.timerTitle);
    ...
    public void onStop() {
        ...
        TaskDescription taskDescription = new TaskDescription("Big Questions Timer", icon, Color.parseColor("#000000"));
    ...
    public void onResume() {
        ...
        if(MainActivityBQ.prep){
            if(MainActivityBQ.aff){
                anim.setDuration(MainActivityBQ.affPrepSeconds);
            }
            else if(!MainActivityBQ.aff){
                anim.setDuration(MainActivityBQ.negPrepSeconds);
            }
        }
        else if(!MainActivityBQ.prep) {
            anim.setDuration(MainActivityBQ.seconds);
        }
    ...
    public void launchMain(View view) {
        ...
        MainActivityBQ.prep = false;

        //finish();
        //startActivity(new Intent(TimerActivityBQ.this, MainActivityBQ.class));
    }
    ...
    public void start(View view) {
        seconds = MainActivityBQ.seconds;
        started = true;
        if (!paused) {
            paused = true;
            ...
            countDownTimer = new CountDownTimer(seconds, 1000) {
                ...
                public void onTick(long millisUntilFinished) {
                    ...
                    MainActivityBQ.seconds = MainActivityBQ.seconds - 1000;
                }
                ...
                public void onFinish() {
                    ...
                    flashScreen();
                    /*if(MainActivityBQ.Aff){
                        boolean b = MainActivityBQ.negCheck;
                        if(MainActivityBQ.negCheck){
                            player.start();
                        }
                        else {
                            flashScreen();
    ...
    public void startAffPrep(View view) {
        seconds = MainActivityBQ.affPrepSeconds;
        started = true;
        if (!paused) {
            paused = true;
            ...
            countDownTimer = new CountDownTimer(seconds, 1000) {
                ...
                public void onTick(long millisUntilFinished) {
                    ...
                    MainActivityBQ.affPrepSeconds = MainActivityBQ.affPrepSeconds - 1000;
                }
    ...
    public void startNegPrep(View view) {
        seconds = MainActivityBQ.negPrepSeconds;
        started = true;
        if (!paused) {
            paused = true;
            ...
            countDownTimer = new CountDownTimer(seconds, 1000) {
                ...
                public void onTick(long millisUntilFinished) {
                    ...
                    MainActivityBQ.negPrepSeconds = MainActivityBQ.negPrepSeconds - 1000;
                }
